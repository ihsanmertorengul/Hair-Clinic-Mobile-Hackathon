...
export default function Step3({ navigation, route }) {
    ...
    const updateAnalysisStep3 = async (photoUrl) => {
        try {
            if (!analysisId) {
            ...
            console.log('Firestore güncellendi: step3 ->', photoUrl);
        } catch (error) {
    ...
    const uploadToCloudinary = async (uri) => {
        try {
            ...
            data.append('file', {
                uri: uri,
                type: 'image/jpeg',
                name: 'image3.jpg', // ismi sabit veya değişken yapabilirsiniz
            });
        ...
        const handleResultTrue = async () => {
            if (result === true) {
                ...
                if (photoUri) {
                    ...
                    // Firestore'a kaydet
                    await updateAnalysisStep3(cloudinaryLink);
                }
            }
        };
    ...
    const sendToServer = async (photoUri) => {
        try {
            ...
            const overlayAsset = Asset.fromModule(require('../../../assets/sonmodel/sol.png'));
        ...
        <SafeAreaView style={styles.safeArea}>
            <View style={styles.container}>
                ...
                <View style={styles.infoCard}>
                    <Text style={styles.infoBadge}>Adım 3 / 5</Text>
                    <Text style={styles.infoTitle}>45° Sol Profil</Text>
                    <Text style={styles.infoSubtitle}>
                        Bu kez başınızı sola çevirin ve yüz hatlarınızın net olduğundan emin olun.
                    </Text>
                </View>
                ...
                <View style={styles.cameraShell}>
                    ...
                    >
                        ...
                        <View pointerEvents="none" style={styles.overlayContainer}>
                            <Image
                                source={require('../../../assets/sonmodel/sol.png')}
                ...
                {result === true && (
                    <TouchableOpacity
                        ...
                        onPress={() => navigation.navigate('Step4', { analysisId })}
                    >
