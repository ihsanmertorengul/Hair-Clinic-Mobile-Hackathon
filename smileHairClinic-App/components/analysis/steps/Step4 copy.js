...
export default function Step4({ navigation, route }) {
    ...
    const takePhotoAndSend = async () => {
        ...
        try {
            ...
            setResult(json);
            setAnalysisOk(json.vertex_ok === true);
            console.log("kafa oranı : " + json.head_ratio);
            if (json.vertex_ok === true) {
                playSuccessSound();   // ✔ başarı sesi çal
