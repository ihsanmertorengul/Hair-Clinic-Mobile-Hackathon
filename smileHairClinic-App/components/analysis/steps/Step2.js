...
export default function Step2({ navigation, route }) {
    ...
    const updateAnalysisStep2 = async (photoUrl) => {
        try {
            if (!analysisId) {
            ...
            console.log('Firestore güncellendi: step2 ->', photoUrl);
        } catch (error) {
    ...
    const uploadToCloudinary = async (uri) => {
        try {
            ...
            data.append('file', {
                uri: uri,
                type: 'image/jpeg',
                name: 'image2.jpg', // ismi sabit veya değişken yapabilirsiniz
            });
    ...
    const sendToServer = async (photoUri) => {
        try {
            ...
            const overlayAsset = Asset.fromModule(require('../../../assets/sonmodel/sag.png'));
        ...
        <SafeAreaView style={styles.safeArea}>
            <View style={styles.container}>
                ...
                <View style={styles.infoCard}>
                    <Text style={styles.infoBadge}>Adım 2 / 5</Text>
                    <Text style={styles.infoTitle}>45° Sağ Profil</Text>
                    <Text style={styles.infoSubtitle}>
                        Başınızı hafifçe sağa çevirip göz hizasında tutun. Kulak hizası kadrajda görünmeli.
                    </Text>
                </View>
                ...
                <View style={styles.cameraShell}>
                    ...
                    >
                        ...
                        <View pointerEvents="none" style={styles.overlayContainer}>
                            <Image
                                source={require('../../../assets/sonmodel/sag.png')}
                ...
                {result === true && (
                    <TouchableOpacity
                        ...
                        onPress={() => navigation.navigate('Step3', { analysisId })}
                    >
